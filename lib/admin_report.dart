...
class AdminReport extends StatefulWidget {
   AdminReport({Key? key, this.depID}) : super(key: key);
                  ...
                  onPressed: () async {
                    if (valueSemesters != null && valueYears != null) {
                      ...
                      await Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (BuildContext context) => AdminResult(depID: widget.depID,valueSemesters:valueSemesters, valueYears:valueYears, result: result.toString().substring(0, 4),)));
                      setState(() {
                        flag = false;
                      });
                    } else {
