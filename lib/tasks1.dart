...
class Tasks1 extends StatefulWidget {
  const Tasks1({Key? key}) : super(key: key);
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: const [
                          Icon(Icons.article_rounded, size: 36,),
                          SizedBox(height: 6,),
                          Text("البيانات الأساسية", style: kTitleTextStyleSMregular,),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: const [
                          ...
                          SizedBox(height: 6,),
                          Text("جميع المهام", style: kTitleTextStyleSMregular,),
                        ],
                      ),
                    ),
                  ),
